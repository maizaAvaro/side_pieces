      ...
      implements Serializable, Cloneable
{
   ...
   /**
    * Index into tuples with Extendable Hashing
    */
   //private final ExtHash <KeyType, Comparable[]> index;
   
   /**
    * Index into tuples with B+Tree
    */
   private final BpTree <KeyType, Comparable[]> index;
   
   /**
    * Index into tuples with Linear Hashing
    */
   //private final  LinHash <KeyType, Comparable[]> index;
   ...
   public Table (String _name, String [] _attribute, Class [] _domain, String [] _key)
   {
       ...
       //index     = new TreeMap <> ();                  
       //index = new ExtHash <> (KeyType.class, Comparable[].class, 11);
       index = new BpTree <> (KeyType.class, Comparable[].class);
       //index = new LinHash <> (KeyType.class, Comparable[].class, 11);
