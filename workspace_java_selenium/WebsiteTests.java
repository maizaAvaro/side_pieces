...
public class WebsiteTests {
	...
	@Test
	public void testWebsiteTests() throws Exception {
		selenium.open("/");
		...
		assertTrue(selenium.isElementPresent("css=option[value=\"Acorn\"]"));
		...
		selenium.waitForPageToLoad("30000");
		selenium.select("id=brand", "label=Gucci");
		selenium.click("id=search_button");
		selenium.waitForPageToLoad("30000");
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[3]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=#lanvin_lanvin_ankle_strap_boot > div.shoe_result > table > tbody > tr.shoe_result_row > td > form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=#jimmy_choo_jimmy_choo_ankle_strap_crystal_pump > div.shoe_result > table > tbody > tr.shoe_result_row > td > form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[6]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[7]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[8]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=#gucci_gucci_lace_up_tall_boot > div.shoe_result > table > tbody > tr.shoe_result_row > td > form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[10]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[11]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[12]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[13]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[14]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[15]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[16]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[17]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=#lanvin_lanvin_platform_pump > div.shoe_result > table > tbody > tr.shoe_result_row > td > form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[19]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("css=#valentino_valentino_bow_overthe_knee_boot > div.shoe_result > table > tbody > tr.shoe_result_row > td > form.notification_email_form > input[name=\"email\"]"));
		...
		verifyEquals("sample@gmail.com", selenium.getValue("xpath=(//input[@name='email'])[21]"));
		...
		selenium.waitForPageToLoad("30000");
		verifyEquals("lalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalala", selenium.getValue("id=remind_email_input"));
		selenium.type("id=remind_email_input", "lalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalala");
		...
		verifyEquals("lalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalal", selenium.getValue("id=promo_code_input"));
		...
		assertTrue(selenium.isElementPresent("css=div.flash.notice"));
		verifyEquals("lalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalala", selenium.getValue("id=promo_code_input"));
		...
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isElementPresent("css=h2"));
		selenium.type("id=issue_title", "Sample Error Message 1");
		selenium.type("id=issue_description", "This is a sample error message 1");
		...
		assertTrue(selenium.isElementPresent("css=div.flash.notice"));
		assertEquals("Sample Error Message 1", selenium.getText("css=#issue_61 > td.issue_title"));
		assertEquals("Medium", selenium.getText("css=#issue_61 > td.issue_severity"));
		assertEquals("This is a sample error message 1", selenium.getText("css=#issue_61 > td.issue_description"));
		selenium.click("link=Report An Issue");
		selenium.waitForPageToLoad("30000");
		selenium.type("id=issue_title", "Sample Error Message 1");
		selenium.type("id=issue_description", "This is a sample error message 1");
